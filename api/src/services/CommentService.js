 ...
 *
 * @typedef {import('../types').CommentRow} CommentRow
 */
...
class CommentService {
   ...
   * @returns {Promise<CommentRow>} Created comment
   */
   ...
   * @returns {Promise<CommentRow[]>} Comments with nested structure
   */
   ...
   * 
   * @param {CommentRow[]} comments - Flat comment list
   * @returns {CommentRow[]} Nested comment tree
   */
