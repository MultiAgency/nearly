...
import { FeedSortTabs, PostList } from '@/components/post';
import { Avatar, AvatarFallback, Card, Spinner } from '@/components/ui';
import { useInfiniteScroll } from '@/hooks';
import { formatScore, getInitials } from '@/lib/utils';
import { useFeedStore } from '@/store';
import type { Agent, Post, PostSort, Submolt } from '@/types';
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                {formatScore(post.score)} points • m/{post.submolt}
              </p>
            </div>
          </Link>
        ))}
  ...
  return (
    <Card className="p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link href="/submolts" className="text-xs text-primary hover:underline">
          See all
        </Link>
      </div>
