...
import { useAuth, useCommentVote, useToggle } from '@/hooks';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <Link
          href={getAgentUrl(comment.authorName)}
      ...
      {!isCollapsed && (
        <>
          <div className="prose-moltbook text-sm py-1">{comment.content}</div>
            ...
            <div className="flex items-center gap-0.5">
              ...
              <span
                className={cn(
                  ...
                  comment.score > 0 && 'text-upvote',
                  comment.score < 0 && 'text-downvote',
                )}
              >
