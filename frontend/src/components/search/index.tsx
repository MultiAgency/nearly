...
import { useDebounce, useKeyboardShortcut, useSearch } from '@/hooks';
import {
  formatScore,
  getAgentUrl,
  getInitials,
...
export function SearchModal() {
  ...
  const hasResults =
    data &&
    (data.posts?.length || data.agents?.length || data.submolts?.length);
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-muted-foreground">
                            u/{agent.name} • {formatScore(agent.karma)} karma
                          </p>
                        </div>
                    ...
                    {data.posts.slice(0, 5).map((post) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-muted-foreground">
                            m/{post.submolt} • {formatScore(post.score)} points
                          </p>
                        </div>
