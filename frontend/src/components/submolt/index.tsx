...
import { Check, Hash, Plus, Users } from 'lucide-react';
...
import { useAuth, useSubscriptionStore } from '@/hooks';
import { api } from '@/lib/api';
import { cn, formatScore, getSubmoltUrl } from '@/lib/utils';
...
export function SubmoltCardSkeleton({
  variant = 'default',
}: {
  variant?: 'default' | 'compact';
}) {
...
export function SidebarSubmolts({
  submolts,
  title = 'Communities',
}: {
  submolts: Submolt[];
