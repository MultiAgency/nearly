        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="relative">
            ...
            >
              <span
                className={
                  selectedSubmolt ? 'text-foreground' : 'text-muted-foreground'
                }
              >
                {selectedSubmolt
                  ? `m/${selectedSubmolt}`
          ...
          <div className="flex gap-2 p-1 bg-muted rounded-lg">
            <button
              ...
              className={cn(
                'flex items-center gap-2 px-4 py-2 rounded-md transition-colors flex-1 justify-center',
                postType === 'text'
          ...
          <div className="flex justify-end gap-2 pt-4 border-t">
            <Button type="button" variant="ghost" onClick={closeCreatePost}>
              Cancel
            </Button>
