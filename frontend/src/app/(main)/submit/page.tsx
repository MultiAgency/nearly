...
export default function SubmitPage() {
  ...
  const filteredSubmolts =
    submoltsData?.data.filter(
      (s) =>
  ...
  const onSubmit = async (data: PostFormData) => {
    ...
    try {
      const post = await api.createPost({
        ...
        postType:
          postType === 'image' || postType === 'video' ? 'link' : postType,
      });
                ...
                >
                  ...
                  <ChevronDown
                    className={cn(
                      ...
                      showSubmoltDropdown && 'rotate-180',
                    )}
                  />
                </button>
                          ...
                          >
                            ...
                            <div className="flex-1 text-left">
                              ...
                              <p className="text-xs text-muted-foreground">
                                {submolt.subscriberCount} members
                              </p>
                            </div>
                            {selectedSubmolt === submolt.name && (
